...
//Individual pieces store any necessary data and behavior for their particular PieceType.
...
public class Piece {
    ...
    // no need to copy image data in our implementation.
    /*
    GENERAL PIECE RULES:
    ...
    */
    ...
    public void initializeImage() {
        String path = "C:\\Users\\rcate\\Downloads\\chuss-main (16)\\chuss-main\\Chuss\\src\\chuss\\icons\\";
        if (color == Color.BLACK) {
            if (type == PieceType.QUEEN )
                image = new ImageIcon(path +"BQ.gif");
            else if (type == PieceType.PAWN)
                image = new ImageIcon(path +"BP.gif");
            else if (type == PieceType.ROOK)
                image = new ImageIcon(path +"BR.gif");
            else if (type == PieceType.KNIGHT)
                image = new ImageIcon(path +"BN.gif");
            else if (type == PieceType.BISHOP)
                image = new ImageIcon(path +"BB.gif");
            else if (type == PieceType.KING)
                image = new ImageIcon(path +"BK.gif");
        } else if (color == Color.WHITE) {
            if (type == PieceType.QUEEN)
                image = new ImageIcon(path + "WQ.gif");
            else if (type == PieceType.PAWN)
                image = new ImageIcon(path +"WP.gif");
            else if (type == PieceType.ROOK)
                image = new ImageIcon(path +"WR.gif");
            else if (type == PieceType.KNIGHT)
                image = new ImageIcon(path +"WN.gif");
            else if (type == PieceType.BISHOP)
                image = new ImageIcon(path +"WB.gif");
            else if (type == PieceType.KING)
                image = new ImageIcon(path +"WK.gif");
        }
...
class Rook extends Piece {
    ...
    */
    ...
    public boolean isLegal(Move move) {
        ...
        c1 = move.getMoveType() == MovePieceType.HORIZONTAL ||
            move.getMoveType() == MovePieceType.VERTICAL;
        //Checks if the move is horizontal or vertical
        if(c1) c1 = move.checkPath(java.awt.Color.YELLOW);
...
class King extends Piece {
    ...
    */
    ...
    public boolean isLegal(Move move) {
        ...
        c1 = (move.getMoveType() == MovePieceType.HORIZONTAL ||
                move.getMoveType() == MovePieceType.VERTICAL ||
                move.getMoveType() == MovePieceType.DIAGONAL) &&
